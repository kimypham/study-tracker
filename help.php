...
<body class="scrollbar">
	<div class="main">
		...
		<br>
		<span class="bold">Changing the type or length of timer:</span> Click on settings icon on the top left of the timer.<br>
		Note: changing the timer on the main timer page will result in any progress recorded to be lost.<br>
		The type and length of the timers can be also adjusted in the settings page.
		</p>
		<br><br>
		...
		<span class="bold">Search for a record:</span> Select/enter in the date of the record you want to view and press enter.<br>
		</p>
		<br><br><br><br><br><br>
