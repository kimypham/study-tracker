	...
	<div class="main" style="background-color: #E3E5E8;">
		...
		<div class="timer_box">
			...
			<div style="display:inline-block; vertical-align:middle;">
				...
				?>
				<br>
				<label>If zincorrect, please input the correct length of time</label>
				<div style="display:inline-block; vertical-align:middle;">
			...
			<form action="work.php?select=<?php echo $_SESSION['select'];?>">
				<button class="controls control_left" style="width: 0%; visibility: hidden;"/>
				<button class="controls control_right"/>Go back to timer
				<button class="controls control_right"/>Done!
			</form>
		</div>
