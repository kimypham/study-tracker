...
<body>
	<div class="main" style="background-color: #E3E5E8;">
			...
			<div class="timer_done">
				...
				<div class="timer_done_controls">
					<form action="timer_done.php" method="POST">
						...
						<button class="controls" type="submit" name="timeInput" style="background-color: #58C898;"></button>
					</form>
				</div>
				<br><br>
			</div>
				<form action="work.php?select=<?php echo $_SESSION['select'];?>">
					<button class="controls control_left" style="width: 10.75%; visibility: hidden;"></button>
		...
		<label style="float:right; margin-right:26vw; font-size:1.5vw;">Note: This timer session will not be <br>recorded and the timer will be reset</label>	
	</div>
</body>