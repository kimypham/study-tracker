<?php
// Study Tracker - Settings (Manage Subjects and Tasks) page, version 1.3, Kim Pham
...
<body>
	<div class="main">
		...
		<p class="subtitle"> Enter in the text box to change the subject/task's name and use the delete button to delete the subject/task.</p><br>
			...
			<div class="button_container">	<!-- no buttons would be shown otherwise -->
						<a href="settings.php" class="no_link"><button class="btn btn_right">Go back</button></a>
					</div>
