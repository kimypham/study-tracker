			...
			<table>
				...
				<?php $this->i = 1; while ($this->row = mysqli_fetch_array($this->tasks)) { ?>
					<tr>
						...
						<td><a class="delete" onclick="return confirm('Delete this item?');" href="index.php?del_task=<?php echo $this->row['id']; ?>"><img src="./images/delete.png" width="20px" height="20px"></a></td>
					</tr>
				<?php $this->i++; } ?>	
				</tbody>
			</table>
